...
#Region "Methods"
    Public Function Validate(ByVal item As T) As ValidationResult
        Dim result As New ValidationResult()
        Me.Validate(item, result)
        Return result
    End Function

    Public Sub Validate(ByVal item As T, ByVal result As ValidationResult)
        For Each method In Me.ValidationMethods.Values
            method.Invoke(item, result)
        Next
    End Sub

    Public Function Validate(ByVal item As T, ByVal propertyName As String) As ValidationResult
        Dim result As New ValidationResult()
        Me.Validate(item, propertyName, result)
        Return result
    End Function

    Public Sub Validate(ByVal item As T, ByVal propertyName As String, ByVal result As ValidationResult)
